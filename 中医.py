...
class Spider(BaseSpider):
    ...
    CATEGORIES = [
        {"type_id": "中医基础理论", "type_name": "中医基础理论"},
        {"type_id": "中药学", "type_name": "中药学"},
        {"type_id": "方剂学", "type_name": "方剂学"},
        {"type_id": "针灸推拿", "type_name": "针灸推拿"},
        {"type_id": "中医诊断学", "type_name": "中医诊断学"},
        {"type_id": "黄帝内经", "type_name": "黄帝内经"},
        {"type_id": "伤寒论", "type_name": "伤寒论"},
        {"type_id": "金匮要略", "type_name": "金匮要略"},
        {"type_id": "温病学", "type_name": "温病学"},
        {"type_id": "中医养生", "type_name": "中医养生"},
        {"type_id": "中医食疗", "type_name": "中医食疗"},
        {"type_id": "中医美容", "type_name": "中医美容"},
    ]
    ...
    def homeVideoContent(self):
        result = {"list": []}
        html = self.getHtml(
            "https://api.bilibili.com/x/web-interface/search/type?search_type=video&keyword=%E4%B8%AD%E5%8C%BB&page=1&order=click",
